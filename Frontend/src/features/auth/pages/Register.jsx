...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#04070c] text-[#e4edf4] flex items-center justify-center p-6 relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,_#25b3d3_0%,_transparent_0%),radial-gradient(circle_at_bottom_right,_rgba(78,153,163,0.18)_0%,_transparent_0%),linear-gradient(180deg,_rgba(4,7,12,0.96)_0%,_rgba(4,7,12,1)_100%)]" />
      <div className="relative z-10 w-full max-w-[320px] rounded-[20px] border border-white/10 bg-white/5 backdrop-blur-xl shadow-[0_20px_48px_rgba(0,0,0,0.4)] px-5 py-5">
        <div className="flex flex-col items-center gap-1 mb-2 text-center">
          ...
          <p className="text-xs text-[#acc7d4] max-w-[270px] mb-2">Sign up now and start exploring AI-powered search.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            <label className="block text-xs mb-2 text-[#c0d0db]">Username</label>
            <input
              type="text"
              value={username}
